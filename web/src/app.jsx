...
export function App() {
  /* Remote page: remote control only. Provisioning lives in the standalone
   * provision.html (served by httpd based on wifi state); no provisioning
   * routing or WS lifecycle here (WS is kept up by main.jsx ensureWs). */
