...
#define EXAMPLE_STD_BCLK_IO1 GPIO_NUM_5 // I2S bit clock io number   I2S_BCLK
#define EXAMPLE_STD_WS_IO1 GPIO_NUM_6   // I2S word select io number    I2S_LRC
#define EXAMPLE_STD_DOUT_IO1 GPIO_NUM_4 // I2S data out io number    I2S_DOUT
