...
extern const unsigned char m68ki_opcode_page_map[256];
extern const unsigned short m68ki_opcode_index_pages[][256];
extern const unsigned char m68ki_cycle_values[];
