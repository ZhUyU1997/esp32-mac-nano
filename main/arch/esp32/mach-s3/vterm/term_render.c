...
static const struct { uint32_t uni; uint8_t cp; } k_cp437_map[] = {
	...
	/* C0 0x01-0x1F VGA glyphs: smilies, card suits, music notes, arrows.
	 * libansilove renders these as glyphs too (verified against its
	 * output); tab/LF/CR/ESC keep their control semantics. */
	{ 0x00A7, 0x17 }, { 0x00B6, 0x16 }, { 0x2022, 0x07 }, { 0x203C, 0x15 },
	{ 0x2192, 0x1A }, { 0x2193, 0x19 }, { 0x2194, 0x1D }, { 0x2195, 0x14 },
	{ 0x221F, 0x1C }, { 0x25AC, 0x18 }, { 0x25B2, 0x1E }, { 0x25BA, 0x12 },
	{ 0x25BF, 0x1F }, { 0x25C4, 0x13 }, { 0x25D8, 0x08 }, { 0x25D9, 0x0B },
	{ 0x263A, 0x01 }, { 0x263B, 0x02 }, { 0x263C, 0x11 }, { 0x2640, 0x0E },
	{ 0x2642, 0x0C }, { 0x2660, 0x06 }, { 0x2663, 0x05 }, { 0x2665, 0x03 },
	{ 0x2666, 0x04 }, { 0x266A, 0x0F }, { 0x266B, 0x10 },
