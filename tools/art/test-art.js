 ...
 *
 * Usage:
 *   node tools/art/test-art.js [options] [sources...]
 *   options:
...
const { EXCLUDE_FILES, EXEMPT_FILES } = require('./lib/exempt-files');
...
function usage() {
	console.error(
		'usage: node tools/art/test-art.js [--extract] [--render] [--count] [options] [sources...]\n' +
